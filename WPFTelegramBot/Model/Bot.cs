...
namespace WPFTelegramBot
{
    class Bot
    {
        private readonly TelegramBotClient bot = new TelegramBotClient("5644872603:AAG7AMjCt4Mh4iqusMEY20Zyxv34kuBBxqM");
        private readonly CancellationTokenSource cts = new CancellationTokenSource();
        ObservableCollection<MessageLog> BotMessageLog { get; }
        ...
        public async Task HandleUpdatesAsync(ITelegramBotClient botClient, Update update, CancellationToken cancellationToken)
        {
            ...
            BotMessageLog.Add( new MessageLog(DateTime.Now.ToLongTimeString(), update));
        }
